...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        System.out.println("Is the character unique? " + r1); // true
        ...
        //   'm'         0         !=            3
        //   'i'         1         !=            4
        //   'a'         2         ==            2       // If a character is unique in a String
                                                         // indexOf() and lastIndexOf() gives the same output
        ...
        String y = "miami";
        char ch = 'a';     bunlar data part. bunlari biz update edebiliyoruz  o yuzden data tipini boyle olusturmamiz lazim



           boolean r1 = y.indexOf(ch) == y.lastIndexOf(ch);
        System.out.println("Is the character unique? " + r1); // false        bunlarda  main code part



         boolean r1 = y.indexOf('a') == y.lastIndexOf('a');
        bu sekildede calisir ama tavsiye edilmez

        code part is like an engine , arabanin motoru bozuldugunda tamirciye goturursun cunku o kritik bi durum senin icin
         ama sandalyesi basit biryerleri kirildiginda kendin tamir edebiliyorsun
