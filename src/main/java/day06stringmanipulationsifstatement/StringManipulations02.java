...
public class StringManipulations02 {
    ...
    public static void main(String[] args) {
        ...
        String t = "";
        //1.Way:
        boolean r3= t.replaceAll("[ ]","").length()==0;// t.replace(" ", "").length()==0 buda kullaniliyor
        ...
        //2.Way        // best way      + ile concat anlami ayni
