...
public class NestedIfStatement01 {
   ...
   If a code has much execution time, it is called "Time consuming(zaman emici) code". Prevent to type time-consuming codes.
   iyi kod kisa koddur
   nested son kullanma durumunuz olmali.
     */

    public static void main(String[] args) {

        // Nested table ic ice gecen kahve icerken kullandigimiz kucuk sehpa masa (zigon)
        ...
        //           If the worker does not define himself as male and female print "Undefined" on the console.
