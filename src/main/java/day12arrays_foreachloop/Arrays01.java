...
public class Arrays01 {
  ...
  /*
                     ...
                     *** Arrayler interviewde cok sorulurlar ***
        1)primitive variables and Strings can store just a single data in them,
          sometimes we need "to store multiple data in the same data type(ayni data tipinde olmali hepsi)" in a single container.
        ...
        2)Arrays cannot store "non-primitives", if you see "non-primitives" were stored actually they are "references of non primitives"
          ...
          NOTE: String ve Array icin length method'larinda dikkatli olmak gerekir.
                          String==> length()
                          Arrays==> length

          char'lar icin default value bosluktur  [ , , , ]
          integer'lar icin default value 0'dir   [0,0,0,0]
          Stringler icin default value null'dir   [null,null,null,null]

           Array'de bir elemanin olup olmadigini kontrol etmek icin binarySearch(array ismi, aradigimiz eleman ) methodu kullanilir
           binarySearch() 'den once Arrays.sort() (yani sartirovka)  yapmali
           sort() methodu kullanmazsaniz buldugunuz sonuc guvenilir olmaz.


             1)  sort() method'u sayisal data type'larini kucukten buyuge siralar(ascending order)
             2)  sort() method'u String data type'larini alfabetik olarak siralar(alphabetical order)
             3)  ascending order + alphabetical order==> Natural Order
             4)  sort() method'u  array elemanlarini "Natural Order" a gore siralar.



           Arrayler hizlidirlar ve memoryde az yer kaplar o yuzden ilkel yani gelismemis olsada collection'a gore yinede kullaniyoruz
    ...
    public static void main(String[] args) {
        ...
        int numOfElements = sixthGraders.length;// bu length() methodu degil sadece length variable'i
        ...
        //2.Way: Use for-each loop (Enhanced Loop - zenginlestirilmis loop)
        int total = 0;
