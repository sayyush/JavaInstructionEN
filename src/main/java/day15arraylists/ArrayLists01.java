...
import java.util.List;
       ...
       //      List<String> name=  List.of("Ali", "Veli", "Can");
      //       System.out.println(name); // [Ali, Veli, Can]
...
public class ArrayLists01 {
    ...
    public static void main(String[] args) {
        ...
        String removedElement = names.remove(2);  // double check sildigi ismi gosteriyor
        ...
        boolean isRemoved2 = ages.remove((Integer) 13); // burasi cok onemli
...
//
     ...
     /*
        ...
        4)Mid level implementation(uygulama)
