...
public class StringBuilder01 {
    ...
    public static void main(String[] args) {
     ...
     /*
        ...
        3)StringBuilder is NOT "thread-safe(   )" and is NOT "synchronized( mantikli siralama corba piserken salata yapmak gibi  )"
        "thread-safe" means being able to do "multiple threads(coklu is yapmak 1 anda 1den fazla is yapmak ve boylece hizlica yapilir isler kisa zamanda task)" at the same time
