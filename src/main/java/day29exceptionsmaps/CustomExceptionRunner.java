...
public class CustomExceptionRunner {
    ...
    //Example 2:Create a method to print grades, the method will throw exception if the grade is negative or greater than 100

    public static void printStudentGrade(int grade) throws IllegalGradeException {

        if (grade < 0 || grade > 100) {
            throw new IllegalGradeException("Negative and greater than 100 grades are not valid");
        } else {
