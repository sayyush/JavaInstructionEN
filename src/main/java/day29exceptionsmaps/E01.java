...
public class E01 {
    ...
    /*
           ...
           5)"throw" can be used just to throw "Run Time Exception"(unchecked exception)
             "throws" can be used to throw both "Run Time Exception" or "Compile Time Exception"(checked exception)
           ...
           2)"Custom Exception Classes" can be "Run Time Exception" or "Compile Time Exception"
