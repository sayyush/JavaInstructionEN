...
public class HashTable01 {
    ...
    public static void main(String[] args) {
        ...
        ht.put("Albania",13000000);
        ht.put("Turkey",81000000);
        //ht.put(null,300);==>null cannot be used in the key of hashtable
        //ht.put("Italy",null)==>null cannot be used in the value of the hashtable
        System.out.println(ht);//{USA=400000000, Albania=13000000, Germany=83000000, Turkey=81000000, Belgium=12000000}
