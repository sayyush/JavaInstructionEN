...
public class Lambda01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        printUpperUniqueSortWithLastCharacter(names);
        System.out.println();
    ...
    public static void printUpperUniqueSortWithLastCharacter(List<String>names){
        names.
                stream().
                distinct().
                map(String::toUpperCase).
    ...
    public static void printSortedByLengthThenFirstChar(List<String>names){
        names.stream().sorted(Comparator.comparing(String::length).thenComparing(t->t.charAt(0))).//if a method needs parameter
