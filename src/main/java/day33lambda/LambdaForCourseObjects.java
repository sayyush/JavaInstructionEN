...
public class LambdaForCourseObjects {
    public static void main(String[] args) {
        ...
        printThirdCourseAfterSortingReverse(courses);//[Course{courseName='Turkish Day Time', numOfStudents=124, season='Summer', averageScore=97.2}]
    }
    ...
    public static void printCourseWhoseAvrIsTheHighest(List<Course> courses){//Course{courseName='Turkish Night Time', numOfStudents=125, season='Winter', averageScore=98.4}
    ...
    //5)Sort the list elements according to the number of students in descending order and print just the third one
    public static void printThirdCourseAfterSortingReverse(List<Course> courses){
