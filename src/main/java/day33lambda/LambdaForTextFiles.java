...
public class LambdaForTextFiles {
    public static void main(String[] args) throws IOException {
        ...
        boolean r1=Files.lines(Paths.get("src/main/java/day33lambda/MyTextFile.txt")).
        ...
        Files.lines(Paths.get("src/main/java/day33lambda/MyTextFile.txt")).
                map(t->t.split(" ")).
                flatMap(Arrays::stream).//breaks the inner stream structure, you will have just words inside the outer stream
        ...
        Files.lines(Paths.get("src/main/java/day33lambda/MyTextFile.txt")).
                ...
                filter(t->t.endsWith("s")).forEach(System.out::println);
        ...
        int r2=Files.lines(Paths.get("src/main/java/day33lambda/MyTextFile.txt")).
                ...
                flatMap(Arrays::stream).
                map(t->t.replaceAll("[^a-zA-Z]","")).
                map(String::length).reduce(Math::addExact).get();
